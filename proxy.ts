...
export async function proxy(request: NextRequest) {
  ...
  // TS null guard satisfied with non-null assertion (session is guaranteed here)
...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp|mp4|webm|mov|avi|ogg)$).*)',
  ],
}